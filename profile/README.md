![{protocell:labs} logo](https://github.com/protocell-labs/.github/blob/main/profile/protocell_labs_logo_anim_01.gif?raw=true)


## Profile

*{protocell:labs}* is a digital laboratory merging artistic and research practice founded in 2021 by [Luka](https://twitter.com/LukaPiskorec) and [Kane](https://twitter.com/00000Kane00000), two computational designers from the far north. We investigate computational structures, mathematical forms of organization, design algorithms, artificial biology, emergent morphogenesis and digital graphics.
...
- **Chain**: Tezos
- **Platform**: [fxhash.xyz](https://www.fxhash.xyz/)
- **Links**: [source](https://github.com/protocell-labs/obscvrvm), [generator](https://protocell-labs.github.io/obscvrvm/), [fxhash](https://www.fxhash.xyz/generative/slug/o-b-s-c-v-r-v-m), [fxfam](https://fxfam.xyz/22182)
...
- **Chain**: Tezos
- **Platform**: [fxhash.xyz](https://www.fxhash.xyz/)
- **Links**: [source](https://github.com/protocell-labs/crystalyx), [generator](https://protocell-labs.github.io/crystalyx/), [fxhash](https://www.fxhash.xyz/generative/slug/crystalyx), [fxfam](https://fxfam.xyz/10555)
...
- **Chain**: Tezos
- **Platform**: [fxhash.xyz](https://www.fxhash.xyz/)
- **Links**: [source](https://github.com/protocell-labs/chromoplasm), [generator](https://protocell-labs.github.io/chromoplasm/), [fxhash](https://www.fxhash.xyz/generative/slug/chromoplasm), [fxfam](https://fxfam.xyz/7879)
...
- **Chain**: Tezos
- **Platform**: [fxhash.xyz](https://www.fxhash.xyz/)
- **Links**: [source](https://github.com/protocell-labs/monocell), [generator](https://protocell-labs.github.io/monocell/), [fxhash](https://www.fxhash.xyz/generative/slug/monocell), [fxfam](https://fxfam.xyz/2679)


## Short-form and multi-edition collections
...
- **Started**: July 2021
- **Chain**: Tezos
- **Platform**: [teia.art](https://teia.art/)
- **Links**: [teia](https://teia.art/luka), [objkt](https://objkt.com/profile/luka/created)